...
object Endpoints {
    ...
    const val SUBSCRIPTION_MENTOR_LIST = "subscription/mentor/list"
    const val SUBSCRIPTION_TOPIC_LIST = "subscription/topic/list"
    ...
    const val RECOMMENDED_MENTOR_LIST = "subscription/recommendation/mentor/list"
    const val RECOMMENDED_TOPIC_LIST = "subscription/recommendation/topic/list"

    const val SIMILAR_CONTENT_LIST = "content/similar"
    const val CONTENT_LIST = "content/list/rotated"
